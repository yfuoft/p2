...
Baseless optimism leads to increased consumer confidence. This leads to increase debt accumulation. These two phenomenon create a positive feedback loop, often resulting in short-term economic gains.
...
```
Developing countries almost always have very unpredictable, and usually very high real Gross Domestic Product per capita growth rates. To make visualization easier, the following graph excludes countries with a real Gross Domestic Product per capita of under five thousand dollars.

```{r}

adjusted_data_bw <- data_bw %>%
  select(year, yr1_fe, yr3_fe, rgdp_gr, rgdpch) %>%
    filter(between(rgdpch, 5000,9999999999))
...
Beaudry, Paul, and Franck Portier. 2004. "An Exploration into Pigou's Theory of Cycles." Journal of Monetary Economics 51 (6): 1183--1216. Beaudry, Paul, and Tim Willems. 2022. "On the Macroeconomic Consequences of Over-Optimism." American Economic Journal: Macroeconomics, 14 (1): 38-59.
