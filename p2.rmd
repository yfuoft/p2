...
data_bw |>
  ...
  geom_line(aes(y = rgdp_gr, color = "Real GDP Growth Rate"))+
  geom_line(aes( y = yr1_fe, color = "One-year forecast error")) +
  geom_line(aes( y = yr3_fe, color = "Three-year forecast error"))+
...
```
By excluding outliers when it comes to the value of real Gross Domestic Product, we get a more relevant visual:
